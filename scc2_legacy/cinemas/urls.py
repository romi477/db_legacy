...
urlpatterns = [
    ...
    path('allproducts/', cache_page(60 * 10)(ProductsList.as_view()), name='all_products'),
    ...
    path('allcustomers/', cache_page(60 * 10)(CustomersList.as_view()), name='all_customers'),
    ...
    path('forms/add-product/', CreateCinema.as_view(), name='new_product'),
]
